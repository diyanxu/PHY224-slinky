...
the resonant values within the range of values in our driving motor are $x, x, x$.
Looking at these values they are not integer values of some fundanmental angular
frequency, rather they are more generally releated to the equation below for 
values of $n = 1,2,3$
\begin{align*}
