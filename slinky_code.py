...
plt.title("Position from Fixed End vs Amplitude with Motor Driven at 10% (ω << ω0)")
plt.xlabel("Position from Fixed End (m)")
plt.ylabel("Amplitude (m)")
plt.legend()

plt.figure(2)
plt.errorbar(data_amplitude_40[:,0], data_amplitude_40[:,1], xerr=error_position_40,
             yerr=error_amplitude_40, fmt='.', label='Data')
plt.plot(data_amplitude_40[:,0], model_linear, '-', label='Linear Model')
plt.title("Position from Fixed End vs Amplitude with Motor Driven at 40% (ω = ω0)")
plt.xlabel("Position from Fixed End (m)")
plt.ylabel("Amplitude (m)")
plt.legend()
